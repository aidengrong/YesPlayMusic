export default {
  ...
  login: {
    ...
    notice: `番茄酱Music promises not to save any of your account information to the cloud.<br />
      ...
      番茄酱Music is not the official website of NetEase Music, please consider carefully before entering account information. You can also go to <a href="https://pan.aidengrong.top">番茄酱的云盘</a>`,
